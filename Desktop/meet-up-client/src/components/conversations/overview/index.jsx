...
const Overview = () => {
    ...
    return ( 
        <div className='bg-darkGray h-screen flex w-full  items-end flex-col'>
            ...
            <ProfileHeader setDrowpDownShowing={setDrowpDownShowing} dropDownShowing={dropDownShowing}/>
            <ul className={`${!dropDownShowing && `hidden` } bg-midGray w-[200px] top-[90px] rounded-lg border-mainGray  border   text-white absolute z-30 `}>
